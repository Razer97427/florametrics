...
<div class="container-fluid">
    ...
    <div>
            <?php if ($isAdmin): ?>
                <p style="margin:0; color: #dc3545; font-weight: bold;">Toute suppression désactive une entrée en base de données. Si vous souhaitez réactiver une ligne désactivée par erreur, veuillez contacter le service informatique.</p>
            <?php endif; ?>
        </div>
