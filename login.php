...
<div class="login-wrapper">
    <div class="login-box">
        ...
        <h2 style="text-align: center; font-weight: 400; color: var(--text-light); margin-bottom: 30px;">Espace de gestion</h2>
        ...
        <form method="POST">
            ...
            <div class="form-group" style="margin-bottom: 25px;">
                ...
                <input type="password" autocomplete="current-password" id="password" name="password" required style="width: 100%; padding: 12px; border: 1px solid var(--border); border-radius: 5px; box-sizing: border-box;">
            </div>
